...
public class DycdropTest {
  ...
  public void f() throws Throwable {
		...
		driver.findElement(By.xpath("//input[@formcontrolname='userid']")).sendKeys(str);
	    ...
	    AssertJUnit.assertEquals("https://www.irctc.co.in/nget/train-search", url);
	  Thread.sleep(3000);
	  driver.quit();
  }
}
